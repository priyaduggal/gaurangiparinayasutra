                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <a class="nav-link" id="v-pills-tab-17" data-toggle="pill" href="#onion" role="tab" aria-controls="v-pills-settings11" aria-selected="false">{{translate('Onion/Garlic')}}</a>
                        ...
                        <div class="col-9">
                            <div class="tab-content" id="v-pills-tabContent">
                              ...
                              <div class="tab-pane fade" id="partner_expectation" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                                ...
                                <div class="tab-pane fade" id="onion" role="tabpanel" aria-labelledby="v-pills-settings11">
                                  
                                @include('admin.members.edit.onion')
                               
                                  @include('admin.members.edit.garlic')
                                </div>
                            </div>
                        </div>
                    </div>
