    ...
    <div class="">
        <div class="row ">
            ...
            <div class="col-md-6 mt-3 mt-sm-0 text-center text-md-right">
                <a href="{{ route('addons.create')}}" class="btn btn-circle btn-primary">{{ translate('Install/Update Addon')}}</a>
            </div>
        </div>
    </div>
    <br>
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $.post('https://activeitzone.com/addons/public/addons', {item: 'matrimonial'}, function(data){
                //console.log(data);
                html = '';
                data.forEach((item, i) => {
                    if(item.link != null){
