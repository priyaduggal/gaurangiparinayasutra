...
.carousel.slide.slide_short {
    height: 300px;
    overflow: hidden; display:none;
}.carousel.slide.slide_short .carousel-inner .carousel-item.mr-0.active {
	...
	<div class="container">
		<div class="row">
		    <div class="col-xxl-6 col-xl-6 col-md-6">
		        <img src="{{ static_asset('assets/img/122.png') }}" class="img-set" />    
		    </div>
			<div class="col-xxl-6 col-xl-6 col-md-6">
				<div class="card">
				    <div class="mb-0 text-left hgh">
							<h1 class="h3 text-primary mb-2">{{ translate('Register Free') }}</h1>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="form-group mb-3">
										<label class="form-label" for="on_behalf">Profile Created For</label>
                      ...
                      @endif
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <small>By clicking on Register free, I agree to the terms & conditions and Privacy policy.</small>
                                </div>
                            </div>
							<div class="mb-5">
								<button type="submit" class="btn btn-block btn-primary new">{{ translate('Create Account') }}</button>
							</div>
