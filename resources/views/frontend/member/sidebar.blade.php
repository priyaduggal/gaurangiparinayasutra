    ...
    <div class="aiz-user-sidenav rounded overflow-hidden">
        <div class="px-4 text-center mb-4">
            <span class="avatar avatar-md mb-3">
             ...
             <form action="{{ route('member.basic_info_update1') }}" method="POST">
            @csrf
            <div class="form-group row">
                <div class="col-md-12">
                    ...
                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                        ...
                        <input type="hidden" name="photo" class="selected-files" value="">
                    </div>
        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                  ...
                  <li class="aiz-side-nav-item">
                    <a href="{{url('/')}}/partner_expectation" class="aiz-side-nav-link">
                        <i class="las la-image aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Partner Expectation') }}</span>
                    </a>
                </li>
                <li class="aiz-side-nav-item">
