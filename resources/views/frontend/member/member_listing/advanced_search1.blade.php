<div class="aiz-filter-sidebar collapse-sidebar-wrap sidebar-xl z-1035">
    ...
    <div class="card collapse-sidebar c-scrollbar-light shadow-none">
        <div class="card-header pr-1 pl-3">			<h6 class="mb-0 h6">Quick Search</h6>
        ...
        <!--    </button>-->
            ...
            <div class="pb-4">
                <form action="{{ route('member.listing') }}" method="get">
                    ...
                    <!--            <label class="form-label" for="name">{{ translate('Onion') }}</label>-->
                    <!--             <select name="onion" id="onion" class="form-control aiz-selectpicker" data-live-search="true" >-->
                    <!--                 <option value="">Choose One</option>-->
                    <!--                 <option value="1" @if($onion==1) selected @endif>Yes</option>-->
                    <!--                 <option value="0"  @if($onion==0) selected @endif>No</option>-->
                    <!--                 </select>-->
                    <!--        </div>-->
                    <!--    </div>-->
                    <!--</div>-->
                    ...
                    <!--    <div class="col-lg-12">-->
                    <!--        <div class="form-group mb-3">    -->
                    <!--            <label class="form-label" for="name">{{ translate('Garlic') }}</label>-->
                    <!--             <select name="garlic" id="garlic" class="form-control aiz-selectpicker" data-live-search="true" >-->
                                 
                    <!--                 <option value="">Choose One</option>-->
                    <!--                 <option value="1"  @if($garlic==1) selected @endif>Yes</option>-->
                    <!--                 <option value="0"  @if($garlic==1) selected @endif>No</option>-->
                    <!--                 </select>-->
                    <!--        </div>-->
                    <!--    </div>-->
                    <!--</div>-->
                        ...
                        </div>												<div class="col">							<label class="form-label" for="name">&nbsp;</label>		                    <button type="submit" class="btn btn-block btn-primary mt-0">{{ translate('Search') }}</button>						</div>
                    </div>
                    <!--<div class="row">-->
                    <!--    <div class="col-lg-12">-->
                    <!--        <div class="form-group mb-3">-->
