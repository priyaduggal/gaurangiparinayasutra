        ...
        <form action="{{ route('member.basic_info_update', $member->id) }}" method="POST">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                   ...
                   <input type="text"  value="Male" class="form-control" placeholder="" readonly>
                   @else
                     <input type="text"  value="Female" class="form-control" placeholder="" readonly>
                   
                   @endif
                    <select class="form-control" name="gender" style="display:none">
