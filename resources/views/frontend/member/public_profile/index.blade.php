...
@section('content')
    <section class="pt-6 bg-primary-grad text-white">
        <div class="container">
            <div class="row">
                <div class="col-md-9 offset-md-3 col-sm-8 offset-sm-4">
                    <div class="px-3 row align-items-center">
                        ...
                        <div class="col-md-4 col-xxl-3">
                            ...
                            <span id="interest_id_{{ $user->id }}" class="text-white d-block fs-13 {{ $interest_class }}" style="color:#fff !important;opacity:1 !important">
                                {{ $interest_text }}
                            </span>
                            </a>
                        </div>
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-4 order-1 order-xl-0">
                    <div class="aiz-profile-sidebar">
                        ...
                        <div class="mb-4 p-4 border rounded border-gray-200 d-none d-xl-block">
                            <div class="fs-12">                                <span class="opacity-60">{{ translate('Member ID: ') }}</span>
                ...
                <div class="tab-content">
                                                ...
                                                <div class="col-sm-6 border-sm-left ">
                                                    <table class="w-100 ml-sm-4">
                                                        <tbody>
                                                            <tr>
                                                                <th class="py-1">
                                                                    {{ translate('Recidency Country') }}</th>
                                                                <td class="py-1">
                    ...
                    @if (get_setting('member_partner_expectation_section') == 'on')
                        <div class="tab-pane fade" id="preference">
                            <!-- Partner Expectation -->							<div class="card">								<div class="card-header">{{ translate('Partner Expectation') }}</div>								<div class="card-body">									<table class="table table-responsive">										<tbody class="w-100" style="display: inline-table;">											<tr>	                                        <th>{{ translate('General') }}</th>                                        <td>{{ !empty($user->partner_expectations->general) ? $user->partner_expectations->general : '' }}                                        </td>                                        <th>{{ translate('Residence Country') }}</th>                                        <td>                                            @php                                                $residence_country = !empty($user->partner_expectations->residence_country_id) ? $user->partner_expectations->residence_country_id : '';                                                if (!empty($residence_country)) {                                                    echo \App\Models\Country::where('id', $residence_country)->first()->name;                                                }                                            @endphp                                        </td>                                    </tr>                                    <tr>                                        <th>{{ translate('Height') }}</th>                                        <td>{{ !empty($user->partner_expectations->height) ? $user->partner_expectations->height : '' }}                                        </td>                                        <th>{{ translate('weight') }}</th>                                        <td>{{ !empty($user->partner_expectations->weight) ? $user->partner_expectations->weight : '' }}                                        </td>                                    </tr>                                    <tr>                                        <th>{{ translate('Marital Status') }}</th>                                        <td>{{ !empty($user->partner_expectations->marital_status->name) ? $user->partner_expectations->marital_status->name : '' }}                                        </td>                                        <th>{{ translate('Children Acceptable') }}</th>                                        <td>{{ !empty($user->partner_expectations->children_acceptable) ? $user->partner_expectations->children_acceptable : '' }}                                        </td>                                    </tr>                                    <tr>                                        <th>{{ translate('Religion') }}</th>                                        <td>{{ !empty($user->partner_expectations->religion->name) ? $user->partner_expectations->religion->name : '' }}                                        </td>                                        <th>{{ translate('Caste') }}</th>                                        <td>{{ !empty($user->partner_expectations->caste->name) ? $user->partner_expectations->caste->name : '' }}                                        </td>                                    </tr>                                    <tr>                                        <th>{{ translate('Sub Caste') }}</th>                                        <td>{{ !empty($user->partner_expectations->sub_caste->name) ? $user->partner_expectations->sub_caste->name : '' }}                                        </td>                                        <th>{{ translate('Language') }}</th>                                        <td>{{ !empty($user->partner_expectations->language->name) ? $user->partner_expectations->language->name : '' }}                                        </td>                                    </tr>                                    <tr>                                        <th>{{ translate('Education') }}</th>                                        <td>{{ !empty($user->partner_expectations->education) ? $user->partner_expectations->education : '' }}                                        </td>                                        <th>{{ translate('Profession') }}</th>                                        <td>{{ !empty($user->partner_expectations->profession) ? $user->partner_expectations->profession : '' }}                                        </td>                                    </tr>                                    <tr>                                        <th>{{ translate('Smoking Acceptable') }}</th>                                        <td>{{ !empty($user->partner_expectations->smoking_acceptable) ? $user->partner_expectations->smoking_acceptable : '' }}                                        </td>                                        <th>{{ translate('Drinking Acceptable') }}</th>                                        <td>{{ !empty($user->partner_expectations->drinking_acceptable) ? $user->partner_expectations->drinking_acceptable : '' }}                                        </td>                                    </tr>                                    <tr>                                        <th>{{ translate('Diet') }}</th>                                        <td>{{ !empty($user->partner_expectations->diet) ? $user->partner_expectations->diet : '' }}                                        </td>                                        <th>{{ translate('Body Type') }}</th>                                        <td>{{ !empty($user->partner_expectations->body_type) ? $user->partner_expectations->body_type : '' }}                                        </td>                                    </tr>                                    <tr>                                        <th>{{ translate('Personal Value') }}</th>                                        <td>{{ !empty($user->partner_expectations->personal_value) ? $user->partner_expectations->personal_value : '' }}                                        </td>                                        <th>{{ translate('Manglik') }}</th>                                        <td>{{ !empty($user->partner_expectations->manglik) ? $user->partner_expectations->manglik : '' }}                                        </td>                                    </tr>                                    <tr>                                        <th>{{ translate('Preferred Country') }}</th>                                        <td>                                            @php                                                $preferred_country = !empty($user->partner_expectations->preferred_country_id) ? $user->partner_expectations->preferred_country_id : '';                                                if (!empty($preferred_country)) {                                                    echo \App\Models\Country::where('id', $preferred_country)->first()->name;                                                }                                            @endphp                                        </td>                                        <th>{{ translate('preferred_state_id') }}</th>                                        <td>                                            @php                                                $preferred_state = !empty($user->partner_expectations->preferred_state_id) ? $user->partner_expectations->preferred_state_id : '';                                                if (!empty($preferred_state)) {                                                    echo \App\Models\State::where('id', $preferred_state)->first()->name;                                                }                                            @endphp                                        </td>                                    </tr>                                    <tr>                                        <th>{{ translate('Family Value') }}</th>                                        <td>{{ !empty($user->partner_expectations->family_value->name) ? $user->partner_expectations->family_value->name : '' }}                                        </td>                                        <th>{{ translate('complexion') }}</th>                                        <td>{{ !empty($user->partner_expectations->complexion) ? $user->partner_expectations->complexion : '' }}                                        </td>                                    </tr>										</tbody>									</table>								</div>							</div>														
                        </div>
                    @endif
                    <div class="tab-pane fade" id="gallery">												<div class="card">							<div class="card-header">								{{ translate('Gallery') }}							</div>							<div class="card-content">								                        @php                            $gallery_image_show = true;                            $gallery_image_privacy = get_setting('gallery_image_privacy');                        @endphp                        @if ($gallery_image_privacy == 'only_me')                            @php $gallery_image_show = false;                                 $profile_picture_show = false;                                $gallery_view_request = \App\Models\ViewGalleryImage::where('user_id', $user->id)->where('requested_by',$auth_user->id)->first();                                if($gallery_view_request != null && $gallery_view_request->status == 1){                                    $gallery_image_show = true;                                }                            @endphp                        @elseif($gallery_image_privacy == 'premium_members')                            @if ($auth_user->membership == 1)                                @php $gallery_image_show = false; @endphp                            @endif                        @endif                        <div class="card-columns position-relative">                            @php                                $gallery_images = \App\Models\GalleryImage::where('user_id', $user->id)                                    ->latest()                                    ->get();                            @endphp                            @foreach ($gallery_images as $gallery_image)                                <div class="card hov-overlay">                                    @if ($gallery_image_show)                                        <img src="{{ uploaded_asset($gallery_image->image) }}" class="card-img"                                            alt="{{ translate('photo') }}">                                        <div class="overlay">                                            <a target="_blank" href="{{ uploaded_asset($gallery_image->image) }}"                                                class="text-white absolute-full d-flex justify-content-center align-items-center"                                                title="View">                                                <i class="las la-search-plus la-2x"></i>                                            </a>                                        </div>                                    @else                                        <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" class="card-img"                                            alt="{{ translate('photo') }}">                                        <div class="absolute-full d-flex justify-content-center align-items-center bg-soft-dark text-white"><i class="las la-lock la-3x"></i></div>                                    @endif                                </div>                            @endforeach                                                        @php                                $gallery_image_privacy = get_setting('gallery_image_privacy');                                $gallery_photo_view_request = \App\Models\ViewGalleryImage::where('user_id', $user->id)->where('requested_by',$auth_user->id)->first();                            @endphp                            @if(count($gallery_images) > 0 && $gallery_image_privacy == 'only_me' && ($gallery_photo_view_request == null || ($gallery_photo_view_request && $gallery_photo_view_request->status == 0)))                                <div class="absolute-full d-flex justify-content-center align-items-center">                                    <button                                         @if ($gallery_photo_view_request == null)                                        onclick="gallery_image_view_request({{ $user->id }})"                                        @endif                                        class="btn btn-primary"                                    >                                    @if($gallery_photo_view_request == null)                                        {{ translate('Send Gallery Photo View Request') }}                                    @elseif($gallery_photo_view_request && $gallery_photo_view_request->status == 0)                                        {{ translate('Gallery Photo View Request Sent') }}                                    @endif                                    </button>                                </div>                            @elseif(count($gallery_images) > 0 && $profile_pic_privacy == 'premium_members' && $auth_user->membership == 1)                                <div class="absolute-full d-flex justify-content-center align-items-center">                                    <a href="{{ route('packages') }}" class="btn btn-primary">{{ translate('Send Gallery View Request') }}</a>                                </div>                            @endif                        </div>                   							</div>						</div>						
					</div>
                </div>
            </div>
        </div>
...
@section('script')
    <script type="text/javascript">
        ...
        // Express Interest
        var remaining_contact_view = {{ get_remaining_package_value(Auth::user()->id, 'remaining_contact_view') }};
