<!--<div class="@if(get_setting('header_stikcy') == 'on') position-fixed @else position-absolute @endif w-100 top-0 z-1020">-->
 ...
 <nav class="navbar navbar-expand-lg navbar-bg align-items-end justify-content-between">
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
              <span class="navbar-toggler-icon"></span>
            </button>
            <a class="navbar-brand p-0 mb-4" href="{{url('/')}}">
                 @if(get_setting('header_logo') != null)
                            ...
                            <img src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}"
                                class="img-fluid" width="220">
                            @endif
                <!--<img src="{{ static_asset('assets/Images/logo.png') }}" class="img-fluid">-->
            ...
            <div class="collapse navbar-collapse justify-content-end " id="navbarTogglerDemo03">
              ...
              <ul class="navbar-nav mt-2 mt-lg-0 ul-bg-color align-items-center    profile_settings">
                  <?php }else{ ?>
                  
                  <ul class="navbar-nav mt-2 mt-lg-0 ul-bg-color align-items-center    ">  
                  
                  <?php } ?>
                    @if (Auth::check())
                      <li class="nav-item">
                  <a class="nav-link pl-4 list-edit-1 pr-4" href="{{url('/')}}">Home</a>
                </li>
                
                <li class="nav-item">
                  <a class="nav-link pl-4 list-edit-1 pr-4" href="{{url('/')}}/about">About</a>
                </li>
                 <!--li class="nav-item">
                  <a class="nav-link pl-4 list-edit-1 pr-4" href="">Success Stories</a>
                </li-->
                 <li class="nav-item">
                  <a class="nav-link pl-4 list-edit-1 pr-4" href="{{url('/')}}/contact">Contact Us</a>
                </li>
                    @else
                <li class="nav-item">
                  <a class="nav-link pl-4 list-edit-1 pr-4" href="{{ route('login') }}">Home</a>
                </li>
                 ...
                 @if (Auth::check())
                   @php
                        ...
                        <li class="d-inline-block d-lg-flex pb-1 {{ areActiveRoutes(['member.listing'],'bg-primary-grad') }}">
                            <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center  pl-4 pr-4"
                                href="{{ route('member.listing') }}">
                                <span class="text-white mb-n1">{{ translate('Search') }}</span>
                            </a>
                        </li>
                   ...
                   <li class="nav-item ">
                            <a href="{{ route('dashboard') }}" class="d-flex align-items-center text-reset pl-4 pr-4">
                        ...
                        <li class="nav-item ">
                            <a href="{{ route('logout') }}"
                               class="nav-link list-edit-1 pr-4">{{translate('Logout')}}</a>
                        </li>
                 @else
                <li class="nav-item">
                  <a class="nav-link list-edit-1 pr-4 pl-4"  href="{{ route('login') }}">LOGIN</a>
                </li>
                <li class="nav-item">
                  <a   href="{{ route('register') }}" class="btn my-2 my-sm-0 but-edit-1">REGISTER FREE</a>
                </li>
                @endif
              </ul>
            </div>
        ...
        <div class="carousel slide    slide_long  " data-ride="carousel"  >
            <div class="carousel-inner ">
                <div class="carousel-item mr-0 active ">
                    <img src="{{ static_asset('assets/Images/background.png') }}" alt="wedding" class="img-fluid" />
                    <div class="carousel-caption p-0 befor-img">
                        <h2 class="slid-text-size">The India's No.1 <span class="text-color">Matrimony</span> Sevice</h2>
                    </div>
                </div>
                <div class="carousel-item mr-0">
                    <img src="{{ static_asset('assets/Images/slide.jpg') }}" alt="wedding" class="img-fluid" />
                    <div class="carousel-caption p-0 befor-img">
                        <h2 class="slid-text-size">The India's No.1 <span class="text-color">Matrimony</span> Sevice</h2>
                    </div>
                </div>
          ...
          <?php }else{ ?>
           <div class="carousel slide   slide_short " data-ride="carousel"  >
            <div class="carousel-inner ">
              <div class="carousel-item mr-0 active ">
                <img src="{{ static_asset('assets/Images/background.png') }}" alt="wedding" class="img-fluid" />
                <div class="carousel-caption p-0 befor-img">
                ...
                <!--<div class=" carousel-item active mr-0 form-bg-1">
                  <div class="container">
                    <div class="row">
                      <div class="col-md-2">
          ...
          <?php } ?>
    <div class="top-navbar bg-white border-bottom z-1035 py-2 d-none d-lg-block" style="display:none !important">
        <div class="container">
