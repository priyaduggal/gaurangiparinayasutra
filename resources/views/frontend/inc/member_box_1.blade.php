<div class="rounded border position-relative overflow-hidden">
	...
	>
		@php
			$avatar_image = $member->member->gender == 1 ? 'assets/img/avatar-place.png' : 'assets/img/female-avatar-place.png';
		...
		<div class="absolute-bottom-left w-100 p-3 z-1">
			...
			<div class="text-center">
				<div class="text-primary fw-500 mb-1">{{ $member->first_name. $profile_picture_show  }}</div>
            <div class="fs-10">
