...
//Route::post('/contact_insert', 'HomeController@contact_insert')->name('contact_insert');

  Route::post('/contact_insert', 'NewsletterController@send_contact')->name('contact_insert');
...
Route::group(['middleware' => ['member','verified']], function(){
    ...
    Route::get('/partner_expectation', 'MemberController@partner')->name('partner');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/members/basic_info_update/{id}', 'MemberController@basic_info_update')->name('member.basic_info_update');
     Route::post('/members/basic_info_update1', 'MemberController@basic_info_update1')->name('member.basic_info_update1');
