...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::post('/members/updategarlic/{id}', 'MemberController@updategarlic')->name('members.updategarlic');
    Route::post('/members/updateonion/{id}', 'MemberController@updateonion')->name('members.updateonion');
